...
// ProgaKursach v2.0.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CProgaKursachApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CProgaKursachApp

CProgaKursachApp::CProgaKursachApp()
{
...
// Единственный объект CProgaKursachApp

CProgaKursachApp theApp;


// Инициализация CProgaKursachApp

BOOL CProgaKursachApp::InitInstance()
{
